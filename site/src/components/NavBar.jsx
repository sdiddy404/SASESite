          ...
          <Navbar bg="light" expand="md" className="navbar">
            <Container fluid>
              <Nav className="page-links">
                <Nav.Link className="page-text" href="#about">About</Nav.Link>
                <Nav.Link className="page-text" href="#events">Events</Nav.Link>
                <Nav.Link className="page-text" href="#contact">Contact Us</Nav.Link>
              </Nav>
