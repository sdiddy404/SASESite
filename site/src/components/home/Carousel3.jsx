  ...
  return (
    ...
    <div className="carousel-viewport">
        <div className="carousel-container">
          ...
          <Image className="carousel-img" src={Deloitte} />
          <Image className="carousel-img" src={Goldman} />
          <Image className="carousel-img" src={Google} />
          <Image className="carousel-img" src={Harvard} />
          <Image className="carousel-img" src={Lockheed} />
          <Image className="carousel-img" src={Microsoft} />
          <Image className="carousel-img" src={Northrop} />
